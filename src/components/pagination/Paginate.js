  ...
  return (
    <div className='flex justify-center items-center'>
        <ReactPaginate 
             ...
             previousClassName={'font-poppins text-[15px] px-3 hover:text-orange-600 hover:font-semibold duration-50'}
             nextClassName={'font-poppins text-[14px] px-3 hover:text-orange-600 hover:font-semibold duration-50'}
